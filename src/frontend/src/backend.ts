...
export class Backend implements backendInterface {
    ...
    async createTask(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint): Promise<void> {
    ...
    async fetchSheetCSV(arg0: string): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.fetchSheetCSV(arg0);
    ...
    async getStoreById(arg0: string): Promise<Store> {
        if (this.processError) {
            try {
    ...
    async getStoresByBrand(arg0: string): Promise<Array<Store>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStoresByBrand(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStoresByStatus(arg0: string): Promise<Array<Store>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStoresByStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStoresBySubscription(arg0: string): Promise<Array<Store>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStoresBySubscription(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasksByPriority(arg0: string): Promise<Array<Task>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasksByPriority(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasksByStatus(arg0: string): Promise<Array<Task>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasksByStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasksByStore(arg0: string): Promise<Array<Task>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasksByStore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
